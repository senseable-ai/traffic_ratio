...
#avg=avg.sort_values('2018_avg') 2018년 기준으로 정렬하기
avg = avg[0:17]

# import pickle

# # with open('avg_data.pkl','wb') as file_obg:
# #     pickle.dump(avg, file_obg)

# with open('avg_data.pkl','rb') as file_obg:
#     avg=pickle.load(file_obg)
...
filter_avg = avg.iloc[:,[1,2,3,4,5]]
years = filter_avg.columns
data = filter_avg.values
regions = avg['시도']
